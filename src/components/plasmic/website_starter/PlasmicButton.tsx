...
// Plasmic Project: 2YheevipY9WVkvu8iKe1yE
// Component: ukJzte-0qqNe
...
import projectcss from "./plasmic.module.css"; // plasmic-import: 2YheevipY9WVkvu8iKe1yE/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: ukJzte-0qqNe/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: L7qVF0dl_dRQ/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: A56n62YDMZrA/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__m3Gdn, {
          [sty.freeBoxcolor_neutral__m3GdnE4CS]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__m3GdnBmtIgZqn0S]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__m3GdnpIrmu]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__m3GdnjKtQj]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__m3GdnyWmOd]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__m3Gdn0H3Ip]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__m3GdnUcjr]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__m3Gdnzqn0S]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__wfJF, {
            [sty.freeBoxcolor_neutral__wfJFE4CS]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__wfJFE4CSVLor]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__wfJFKhLHm]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__wfJFjKtQj]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__wfJF0H3Ip]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__wfJFUcjr]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__wfJFzqn0S]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__o9UxC)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__qbhMy, {
            [sty.freeBoxiconEnd__qbhMy4Id33]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__qbhMyjKtQj]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__qbhMy0H3Ip]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__qbhMyUcjr]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__uLx9)}
                role={"img"}
              />
            ),
